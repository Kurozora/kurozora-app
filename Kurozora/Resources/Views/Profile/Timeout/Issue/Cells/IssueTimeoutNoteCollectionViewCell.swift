//
//  IssueTimeoutNoteCollectionViewCell.swift
//  Kurozora
//
...
protocol IssueTimeoutNoteCollectionViewCellDelegate: AnyObject {
	/// Tells the delegate the note text changed.
	///
	/// - Parameters:
...
class IssueTimeoutNoteCollectionViewCell: KCollectionViewCell {
	// MARK: - Views
	...
	// MARK: - Properties
	weak var delegate: IssueTimeoutNoteCollectionViewCellDelegate?

	private static let characterLimit = 2000
	...
	///
	/// - Parameters:
	///    - text: The current note text.
	///    - placeholder: The placeholder shown when the text is empty.
	///    - delegate: The delegate that receives edit events.
	func configure(text: String, placeholder: String, delegate: IssueTimeoutNoteCollectionViewCellDelegate?) {
		self.hideSkeleton()
...
extension IssueTimeoutNoteCollectionViewCell: UITextViewDelegate {
	func textViewDidChange(_ textView: UITextView) {
		...
		self.delegate?.issueTimeoutNoteCollectionViewCell(self, didChange: trimmed)
	}
}
