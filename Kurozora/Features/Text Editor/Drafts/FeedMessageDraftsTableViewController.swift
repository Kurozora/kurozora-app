...
final class FeedMessageDraftsTableViewController: KTableViewController {
	...
	override func viewDidLoad() {
		...
		self.refreshControl?.attributedTitle = NSAttributedString(string: L10n.pullToRefreshItems(L10n.drafts.lowercased(with: Locale.current)))
		#endif
	...
	private func loadDrafts() {
		#if !targetEnvironment(macCatalyst)
		self.refreshControl?.attributedTitle = NSAttributedString(string: L10n.refreshingItems(L10n.drafts.lowercased(with: Locale.current)))
		#endif
