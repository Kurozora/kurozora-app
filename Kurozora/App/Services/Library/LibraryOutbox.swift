...
actor LibraryOutbox {
	...
	func enqueueRate(score: Double, description: String?, trackableID: String, userSlug: String, kind: LibraryKind) async {
		...
		await LibraryStore.shared.applyRating(score: score, description: description, note: nil, isSpoiler: nil, recommendation: nil, forTrackableID: trackableID, userSlug: userSlug, kind: kind)
		self.scheduleFlush()
	}
