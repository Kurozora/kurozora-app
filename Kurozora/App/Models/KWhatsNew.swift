...
class KWhatsNew {
	...
	static var v1_12_0: [WhatsNewItem] = [
		.image(title: "7 Years of Kurozora", subtitle: "Celebrate this special occasion with all new, and old, app icons!", image: R.image.icons.kuroChan()!),
		.image(title: "Episodes, Enhanced.", subtitle: "Revamped episode details, added suggestions, proper season names, and correct navigation titles.", image: R.image.icons.tvSparkles()!),
		.image(title: "Rate All the Things", subtitle: "You can now rate and review characters and people. Let your voice be heard across the cast!", image: R.image.icons.rate()!),
		.image(title: "See All Reviews", subtitle: "Tap into a dedicated list to read all reviews for a title.", image: R.image.icons.rating()!),
		.image(title: "Pinned Posts", subtitle: "You can now pin your favorite feed messages to your profile. Show off your best takes!", image: R.image.icons.messagePin()!),
		.image(title: "Feed Fixes", subtitle: "No more repeating posts, crashes on delete, or stale content after posting—your feed just works.", image: R.image.icons.message()!),
		.image(title: "Smoother Searches", subtitle: "Fixed crashes on pagination and made the search bar prominent, so it’s no longer hiding from you.", image: R.image.icons.search()!),
		.image(title: "Library, Leveled Up", subtitle: "New library settings, default sorting options, proper button states, and UI fixes for better tracking.", image: R.image.icons.libraryGear()!),
		.image(title: "Design Polish", subtitle: "From better button spacing to consistent title bars—your Kurozora experience just got a visual glow-up.", image: R.image.icons.clearCache()!),
		.image(title: "Settings & Navigation", subtitle: "Motion preferences, Image Playground support, smoother request handling, accurate back button titles, and more.", image: R.image.icons.wrenchAndScrewdriverFill()!),
		.image(title: "Bug Fixes", subtitle: "Crashes caused by silly bugs have been fixed. Bad Kirito has been bonked accordingly.", image: R.image.icons.ladybug()!)
	]
	...
	static var v1_10_0: [WhatsNewItem] = [
		...
		.image(title: "Bug Fixes", subtitle: "Emptied two cans of premium bug spray to fix minor issues such as default themes not loading when not connected to the internet, pull-to-refresh not completing the refresh action correctly, and Re:CAP showing multiple months worth of statistics.", image: R.image.icons.ladybug()!)
	]
	...
	static var v1_9_0: [WhatsNewItem] = [
		...
		.image(title: "Spotlight Shortcuts", subtitle: "With Spotlight shortcuts, you can quickly visit the page you want in Kurozora right from your Home Screen!", image: R.image.icons.square2Layers3dTopFilled()!),
		...
		.image(title: "Bug Fixes", subtitle: "More pesky bugs have been swatted, sprayed, and squashed. For example, the music play button will now correctly show the status of the played song.", image: R.image.icons.ladybug()!)
	]
	...
	static var v1_8_0: [WhatsNewItem] = [
		...
		.image(title: "Date Widget", subtitle: "Personalize your home screen with the new Kurozora Date widget, cycling through episode, anime, manga, and game images. Customize options by tapping on the widget while in wiggle mode.", image: R.image.icons.widget()!),
		.image(title: "Search from Anywhere", subtitle: "Expand your search capabilities with the new『Find on Kurozora』Shortcuts app action, enabling convenient access to Kurozora from anywhere you want.", image: R.image.icons.square2Layers3dTopFilled()!),
		...
		.image(title: "Direct Engagement", subtitle: "Engage directly with other users by mentioning them in messages composed on their profile pages.", image: R.image.icons.messagePerson2()!),
		.image(title: "Updated Feature Lists", subtitle: "Stay informed about the latest features with updated feature lists for Pro and Kurozora+ members.", image: R.image.icons.unlock()!),
		.image(title: "Bug Fixes", subtitle: "Experience smoother navigation with fixes to theme store button roundness and crashes when switching accounts using the Account Switcher feature (long hold tab bar for quick access).", image: R.image.icons.ladybug()!)
	]
	...
	static var v1_4_0: [WhatsNewItem] = [
		...
		.image(title: "Favorites Library", subtitle: "Your Favorites library now encompasses manga and games, making it even simpler to keep track of your preferred content.", image: R.image.icons.heartCircle()!),
		...
		.image(title: "Game On!", subtitle: "Stay Ahead of the Game! Game tracking on Kurozora is now a breeze. Explore a wide variety of anime-related games, keep track of your favorites, and never miss a beat on the latest anime-inspired titles. Expand your universe beyond TV and books!", image: R.image.icons.joystick()!),
		.image(title: "UAL", subtitle: "With PRO and Kurozora+ you can now use the new Unified Anime Linking feature. It supports up to 12 services!", image: R.image.icons.at()!),
