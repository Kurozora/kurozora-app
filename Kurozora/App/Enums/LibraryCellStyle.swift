...
enum LibraryCellStyle: Int {
	...
	static let all: [LibraryCellStyle] = [.compact, .detailed, .list, .table]
...
/// Controls title visibility for cells rendered with the ``LibraryCellStyle/compact`` layout.
///
/// ```swift
/// case always = 0
/// case never = 1
/// case smart = 2
/// ```
enum LibraryCompactTitleVisibility: Int, CaseIterable {
	// MARK: - Cases
