...
class AnimeLibraryViewController: ButtonBarPagerTabStripViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.defaultCenter().addObserver(self, selector: "updateLibrary", name: LibraryUpdatedNotification, object: nil)
        NotificationCenter.defaultCenter().addObserver(self, selector: "controllerRequestRefresh", name: LibraryCreatedNotification, object: nil)
