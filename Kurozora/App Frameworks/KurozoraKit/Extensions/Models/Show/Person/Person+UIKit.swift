...
extension Person {
	...
	/// Create a context menu configuration for the person.
	///
	/// - Parameters:
	...
	///
	/// - Returns: A `UIContextMenuConfiguration` representing the context menu for the person.
	///
	...
	/// Create a context menu for the person.
	///
	/// - Parameters:
	///    - viewController: The view controller presenting the context menu.
	///    - userInfo: Additional information about the context menu.
	...
	///    - barButtonItem: The `UIBarButtonItem` sending the request.
	///
	/// - Returns: A `UIMenu` representing the context menu for the person.
	///
	/// - NOTE: If both `sourceView` and `barButtonItem` are provided, `sourceView` will take precedence.
