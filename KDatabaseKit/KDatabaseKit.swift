...
//        let controller = KDatabaseKit.commentStoryboard().instantiateViewController(withIdentifier: "NewPost") as! NewPostViewController
//        return controller
//    }
//
//    public class func newThreadViewController() -> NewThreadViewController {
//        let controller = KDatabaseKit.commentStoryboard().instantiateViewController(withIdentifier: "NewThread") as! NewThreadViewController
//        return controller
//    }
//
//    public class func loginViewController() -> LoginViewController {
//        let storyboard = UIStoryboard(name: "Login", bundle: KDatabaseKit.bundle())
...
//        let controller = UIStoryboard(name: "InAppBrowser", bundle: Bundle(for: self)).instantiateInitialViewController() as! UINavigationController
